...
public class MainController {
    ...
    public ModelAndView logoone(HttpServletRequest request, HttpServletResponse response) {
         ...
         * for(videoEntity ts:test){ log.info("测试是否查询出来");
         * log.info(ts.getVideoName());
         * log.info(ts.getVideoTime()); } 可以查询出这么多条记录
         */
        /* log.info("测试"); */
/*		
		try {
    ...
    public @ResponseBody
    void ajaxTuiJian(HttpServletRequest request, HttpServletResponse response) throws IOException {
    ...
    public @ResponseBody
    void webajax2(HttpServletRequest request, HttpServletResponse response) throws IOException {
     ...
     * log.info(li.getMessageuserName()); } return "";
     *
     * }
     */
    ...
    public ModelAndView Houtai(HttpServletRequest request) {
        ...
        /*
         * for(userEntity lis:list){ log.info(lis.getUserName()); }
         */
...
//		String category = request.getParameter("category");
        ...
        log.info("视频一共有" + request.getParameter("category"));
    ...
    void gouwuche(HttpServletRequest request, HttpServletResponse response, String userName,
        ...
        /*
         * log.info(girdsID);log.info(userName);System.out.
         * println(girdsName);log.info(girdsimg);log.info(
         * girdsjiage);
         */
...
//        }
    ...
    public String videoFileTop(@RequestParam("files") MultipartFile[] files, HttpServletRequest request, String biaoti,
                               String Fruit) {
        log.info("用户输入的标题为:" + biaoti + Fruit);
...
//						video123.setVideoImage("/static/videolook/videolookimg/"+file.getOriginalFilename());
    ...
    void baifenbiAJAX(HttpServletRequest request, HttpServletResponse response)
        ...
        if (request.getSession().getAttribute("video") == null) {
             ...
             * log.info("线程休息出错"); e.printStackTrace(); }
             */
        } else {
