...
<div class="all-comments">
    <div class="all-comments-info">
        ...
        <div style="margin-left:150px" class="box">
            ...
            <input type="text" id="shipingID" style="display: none" name="shipingID"
                   value="<%=request.getAttribute("shipingID")%>">
    ...
    <div align="center">
        <button type="button" id="buttonhide">动态留言板</button>&nbsp;&nbsp;&nbsp;&nbsp;<button type="button"
                                                                                            id="buttonhide2">静态留言板
    </button>
    </div>
    ...
    <div class="wp" style="background-color: #E8E8E8" id="danmu">
        <ul id="slider" class="slider">
            <c:forEach items="${messagelist}" var="messagelist">
                <li>
                    <a class="fl" href=""><img src="<%=request.getContextPath()%>${messagelist.messageHand}" alt=""
                                               width="70px" ;height="70px"/></a>
                    <p>${messagelist.message}</p>
                    <br>
                    <p style="color: red;">留言者:<a href=""
                                                  style="color: darkgoldenrod;text-decoration:none;">&nbsp;${messagelist.messageuserName}</a><span
                            style="color: blue;">&nbsp;&nbsp;&nbsp;留言时间:${messagelist.messageTime}</span></p>
                </li>
            </c:forEach>
        </ul>
    </div>
