    ...
    <div class="row">
        ...
        <div class="span8">
            <div class="well well-small pull-right user-panel-mini">
                            ...
                            <ul class="nav nav-pills" style="margin-bottom: 0px">
                                ...
                                <li class="pull-right" style="padding-top: 4px;"><label
                                    ...
                                    <button type="submit" class="btn btn-primary pull-left"
                                            tabindex="904" style="width: 75px;">登录
                                    </button>
                                </li>
                            </ul>
                        </form>
                ...
                <script src="<%=request.getContextPath()%>/static/Forum/js/md5.js" type="text/javascript"
                        reload="1"></script>
            </div>
        </div>
    </div>
...
<div class="title-frame title-frame-big ">
    ...
    <div class="container ">
        <div id="chart " class="bm bw0 cl small-bar ">
            ...
            <div class="chart z ">
                今日: <em><span style="color: red">${onedaycount}</span></em><span class="pipe ">|</span>昨日: <em><span
                    style="color: red">${yessdaycount }</span></em><span
                    class="pipe ">|</span>帖子: <em><span style="color: red">${messacount }</span></em><span
                    class="pipe ">|</span>会员:
...
<style id="diy_style " type="text/css ">#portal_block_71 {
            ...
            <div class="title-frame title-frame-big flg ">
                <div class="title ">
							<span class="o pull-right "> <img id="category_705_img "
                                                              src="picture/collapsed_no.gif " title="收起/展开 "
                                                              alt="收起/展开 "
                ...
                <div id="category_705 " class="bm_c category " style="">
                    <div class="forum-block ">
                        <div class="icon ">
                            <!--<br/>-->
                            <a href="Forum"><img
                                    src="<%=request.getContextPath()%>/static/Forum/picture/common_343_icon.png "
                                    align="left " alt=" "/></a>
                        </div>
                    ...
                    <div class="forum-block ">
                        <div class="icon ">
                            <!--<br/>-->
                            <a href="Forum"><img
                                    src="<%=request.getContextPath()%>/static/Forum/picture/common_707_icon.png "
                                    align="left " alt=" "/></a>
                        </div>
                    ...
                    <div class="forum-block ">
                        <div class="icon ">
                            <!--<br/>-->
                            <a href="Forum"><img
                                    src="<%=request.getContextPath()%>/static/Forum/picture/common_709_icon.png "
                                    align="left " alt=" "/></a>
                        </div>
                    ...
                    <div class="forum-block ">
                        <div class="icon ">
                            <!--<br/>-->
                            <a href="Forum"><img
                                    src="<%=request.getContextPath()%>/static/Forum/picture/common_708_icon.png "
                                    align="left " alt=" "/></a>
                        </div>
                    ...
                    <div class="forum-block ">
                        <div class="icon ">
                            <!--<br/>-->
                            <a href="Forum"><img
                                    src="<%=request.getContextPath()%>/static/Forum/picture/common_762_icon.png "
                                    align="left " alt=" "/></a>
                        </div>
            ...
            <div class="title-frame title-frame-big flg ">
                <div class="title ">
							<span class="o pull-right "> <img id="category_594_img "
                                                              src="<%=request.getContextPath()%>/static/Forum/picture/collapsed_no.gif "
                ...
                <div id="category_594 " class="bm_c category " style="">
                    <div class="forum-block ">
                        <div class="icon ">
                            <!--<br/>-->
                            <a href="Forum"><img
                                    src="<%=request.getContextPath()%>/static/Forum/picture/common_557_icon.png "
                                    align="left " alt=" "/></a>
                        </div>
                    ...
                    <div class="forum-block ">
                        <div class="icon ">
                            <!--<br/>-->
                            <a href="Forum"><img
                                    src="<%=request.getContextPath()%>/static/Forum/picture/common_779_icon.png "
                                    align="left " alt=" "/></a>
                        </div>
                    ...
                    <div class="forum-block ">
                        <div class="icon ">
                            <!--<br/>-->
                            <a href="Forum"><img
                                    src="<%=request.getContextPath()%>/static/Forum/picture/common_764_icon.png "
                                    align="left " alt=" "/></a>
                        </div>
                ...
                <div id="category_755 " class="bm_c category " style="">
                    <div class="forum-block ">
                        <div class="icon ">
                            <!--<br/>-->
                            <a href="Forum"><img
                                    src="<%=request.getContextPath()%>/static/Forum/picture/common_778_icon.png "
                                    align="left " alt=" "/></a>
                        </div>
                    ...
                    <div class="forum-block ">
                        <div class="icon ">
                            <!--<br/>-->
                            <a href="Forum"><img
                                    src="<%=request.getContextPath()%>/static/Forum/picture/common_763_icon.png "
                                    align="left " alt=" "/></a>
                        </div>
                    ...
                    <div class="forum-block ">
                        <div class="icon ">
                            <!--<br/>-->
                            <a href="Forum"><img
                                    src="<%=request.getContextPath()%>/static/Forum/picture/common_770_icon.png "
                                    align="left " alt=" "/></a>
                        </div>
                ...
                <div id="category_8 " class="bm_c category " style="">
                    <div class="forum-block ">
                        <div class="icon ">
                            <!--<br/>-->
                            <a href="Forum"><img
                                    src="<%=request.getContextPath()%>/static/Forum/picture/common_703_icon.png "
                                    align="left " alt=" "/></a>
                        </div>
                    ...
                    <div class="forum-block ">
                        <div class="icon ">
                            <!--<br/>-->
                            <a href="Forum"><img
                                    src="<%=request.getContextPath()%>/static/Forum/picture/common_38_icon.png "
                                    align="left " alt=" "/></a>
                        </div>
