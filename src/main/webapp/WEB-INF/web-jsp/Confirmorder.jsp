...
<div style="width: 1000px;height: 500px;background-color: white;position: fixed; z-index: 999;margin-left:12%;display: none"
     id="zhifumima">
    <div align="right" style="width: 1000px">
        <button type="button" id="clos">X</button>
    </div>
    <br><br><br><br><br><br><br>
    <div align="center" id="pwd">请输入支付密码:<input type="password" id="oText"><input type="button" id="zhifu" value="支付"
...
<script type="text/javascript">
    ...
    $("#zhifu").click(function () {
        ...
        if (pass == "" || pass == "null") {
            ...
            jQuery.post("yanzhengpass.sf", {
                "pass": pass,
                "zong": zong,
                "shangpingmingzi": shangpingmingzi,
                "shangpingtupiao": shangpingtupiao,
                "dizhi": dizhi
            }, function (test) {
                var ht = eval("(" + test + ")");
                    ...
                    <li class="J_Addr J_MakePoint clearfix  J_DefaultAddr "
                        ...
                        <div class="address-info">
                            <a href="#" class="J_Modify modify J_MakePoint"
                               data-point-url="Delivery_address.sf">修改本地址</a>
                            <input name="address"
                                   class="J_MakePoint "
                                   type="radio"
                                   value="674944241"
            ...
            <div>
                ...
                <table cellspacing="0" cellpadding="0" class="order-table" id="J_OrderTable" summary="统一下单订单信息区域">
                    ...
                    <tr class="shop blue-line">
                        <td colspan="3">
                            店铺：<a class="J_ShopName J_MakePoint" data-point-url="http://log.mmstat.com/buy.1.6"
                    ...
                    <tr class="item" data-lineid="19614514619:31175333266:35612993875" data-pointRate="0">
                        <td class="s-title">
                            <a href="#" target="_blank" title="${grids.girdsName}" class="J_MakePoint"
                               data-point-url="http://log.mmstat.com/buy.1.5">
                                <img src="<%=request.getContextPath()%>${grids.girdsimg}" class="itempic"><span
                                    class="title J_MakePoint"
                                    data-point-url="http://log.mmstat.com/buy.1.5">${grids.girdsName }</span></a>
                                    ...
                                    <div class="farearea">
                                        <ul class="dib-wrap J_farearea">
                                            ...
                                            <li class="dib sel"
                                                ...
                                                <select name="1704508670:2|post" id="selectsf" class="J_Fare"
                                                        onchange="xuanzhong()">
                                                    <option data-fare="1500" value="15" data-codServiceType="2"
                                                            data-level="" selected="selected">
                                                        快递 15.00元
                                                    </option>
                                                    <option data-fare="2500" value="25" data-codServiceType="7"
                                                            data-level="">
                                                        EMS 25.00元
                                                    </option>
                                                    <option data-fare="1500" value="35" data-codServiceType="1"
                                                            data-level="">
                                                        平邮 35.00元
                                                    </option>
                                                </select>
...
<!--  <em class="style-normal-bold-red J_FareSum"  >30.00</em> -->
                    ...
                    <tr class="shop-total blue-line">
                        <td colspan="5">店铺合计(<span class="J_Exclude" style="display: none">不</span>含运费<span
 ...
 <span>&yen;</span><em class="style-large-bold-red" id="J_ActualFee"></em>
                                ...
                                <div class="J_confirmError confirm-error">
                                    <div class="msg J_shopPointError" style="display: none;"><p class="error">
                                        积分点数必须为大于0的整数</p></div>
                                </div>
