...
<head>
    ...
    <link rel="stylesheet" type="text/css"
          href="<%=request.getContextPath()%>/static/grids/gridsPay/css/normalize.css"/>
    <script
            src="<%=request.getContextPath()%>/static/Homepage/js/jquery.min.js"></script>
    <script src="<%=request.getContextPath()%>/static/grids/gridsPay/js/common.js" type="text/javascript"
...
<div class="showall" align="center">
    ...
    <div class="tb-property">
        ...
        <div class="nobdr-btns">
            <button class="addcart yh" id="lijigoumai"><img
                    src="<%=request.getContextPath()%>/static/grids/gridsPay/images/ht.png" width="25" height="25"/>立即购买
            </button>
            <button class="addcart hu" id="gouwuce"><img
                    src="<%=request.getContextPath()%>/static/grids/gridsPay/images/shop.png" width="25" height="25"/>加入购物车
            </button>
        </div>
        <div class="guarantee">
            <span>邮费：包邮&nbsp;&nbsp;支持货到付款 <a href=""><img
                    src="<%=request.getContextPath()%>/static/grids/gridsPay/images/me.png"/></a></span>
        </div>
    </div>
    <script type="text/javascript">
