...
public class UserListDaoImpl implements UserListDao {
    ...
    public List<messageEntity> messagelist(String videoID) {
        ...
        //根据名字查询出用户对象. - -
        String sql = "select * from message WHERE messagevideoID=15 order by STR_TO_DATE(messageTime,'%m/%d/%Y %h:%i:%s %p') desc";
        ...
        list = jdbcTemplate.getJdbcTemplate().query(sql, new RowMapperVideoEntity());
