        ...
        <div class="hdc cl margin-top-bottom">
            <div class="login-container" align="center">
                <div class="well well-small pull-right user-panel-mini">
                    <script src="<%=request.getContextPath()%>/static/Forum/js/logging.js"
                                ...
                                <div class="controls controls-row">
                                    <input class="input-medium" type="text" name="username"
                                           ...
                                           tabindex="901"/> <input class="input-medium" placeholder="密码"
                                                                   type="password" name="password" id="ls_password"
                                                                   class="px vm"
                        ...
                        <c:forEach items="${list}" var="list">
                            ...
                            <tr>
                                ...
                                <th class="new"><a class="tdpre y"
                                    ...
                                    <a href="forumReply.sf?forumID=${list.forumID}" onclick="atarget(this)"
                                       class="s xst">${list.forumBT }</a> <span class="tps">&nbsp;<a
                                            href="forumReply.sf?forumID=${list.forumID}"></a></span></th>
                                <td class="by"><cite> <a href="forumReply.sf?forumID=${list.forumID}" c="1"
                                                         style="color: #333333;">${list.forumuserName }</a></cite>
                        ...
                        <div class="cl">
                            ...
                            <div class="hasfsl" id="fastposteditor">
                                <div class="tedt">
                                    <div class="bar">
                                        <span class="y"> </span>
                                        <script src="<%=request.getContextPath()%>/static/Forum/js/seditor.js"
                                                type="text/javascript"></script>
                                        <div class="fpd">
